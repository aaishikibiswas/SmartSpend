...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="mx-auto min-h-[calc(100vh-1rem)] max-w-[1460px] overflow-hidden rounded-[28px] border border-[#27314d] bg-[#09101d] shadow-[0_30px_90px_rgba(1,6,18,0.55)] lg:pl-64">
      <Sidebar />
